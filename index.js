...
const projectsArray = [
  ...
  {
    name: 'OKP4 Testnet Guide',
    description:
      'A simple guide how to run OKP4 Testnet Node',
    techs: ['Shell'],
    featuredImage: 'images/okp.png',
    featuredPopupImage: 'images/okp.png',
    linkToLiveVersion: 'https://github.com/okp4',
    linkToSource: 'https://github.com/elangrr/testnet_guide/tree/main/okp',
    class: 'project6',
    id: 'but6',
  },
  {
    name: 'Neutron Testnet Guide',
    description:
      'A simple guide how to run Neutron Testnet',
    techs: ['Shell'],
